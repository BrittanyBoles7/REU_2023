...
```{r}
#NEED TO CHOOSE VERSION BEFORE RUNNING
# Choose what tool/versions you want to compare, note you can use the same tool and compare different versions
tool1 <- "T_0.XX.0"
tool2 <- "G_0.XX.0"
...
merged <-
  merge(
    df_tool1,
    df_tool2,
    by = c("imageName", "vulnerabilityID", "severity"),
    all = TRUE
  )
...
output_name_imagePreserver <-
  paste0(tool1, "vs", tool2, "severity_images_ID.csv")
output_name_netDifferences <-
  paste0(tool1, "vs", tool2, "severity_net_ID.csv")
